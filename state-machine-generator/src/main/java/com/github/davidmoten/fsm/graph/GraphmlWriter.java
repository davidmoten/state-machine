...
public class GraphmlWriter {
	...
	private static void printNode(PrintWriter out, GraphNode node, Function<GraphNode, NodeOptions> options,
			boolean includeDocumentation) {
		...
		out.println("            <y:NodeLabel modelName=\"internal\" modelPosition=\"" + modelPosition + "\">"
				+ escapeXml10("<html><p><b>" + node.state().name() + "</b></p>"
						+ (includeDocumentation ? node.state().documentation().orElse("") : "") + "</html>")
				+ "</y:NodeLabel>");
