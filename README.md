...
readyToCook
  ...
  .to(readyToCook
       .from(doorOpen
              ...
              .from(cooking))));
```
As you can see the definition is very concise. This is largely because of the advisable constraint that any one State can only be arrived at via one Event type.
